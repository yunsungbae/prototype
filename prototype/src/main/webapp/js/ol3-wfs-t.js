...
$('.btnMenu').on('click', function(event) {
	...
	pmap.removeInteraction(interaction);
	select.getFeatures().clear();
	pmap.removeInteraction(select);
	switch($(this).attr('id')) {
	...
	case 'btnSelect':
		...
		pmap.addInteraction(interaction);
